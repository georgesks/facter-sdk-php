...
/**
 * CancellationStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  Facter\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CancellationStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancellationStatusResponse';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'message' => 'string',
        'data' => '\Facter\Sdk\Model\CancellationStatusResponseData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Facter\Sdk\Model\CancellationStatusResponseData|null
     */
     ...
     * Sets data
     *
     * @param \Facter\Sdk\Model\CancellationStatusResponseData|null $data data
     *
     * @return self
     */
