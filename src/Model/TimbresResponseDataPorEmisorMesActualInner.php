<?php
/**
 * TimbresResponseDataPorEmisorMesActualInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * TimbresResponseDataPorEmisorMesActualInner Class Doc Comment
 *
 * @category Class
 * @package  Facter\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class TimbresResponseDataPorEmisorMesActualInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimbresResponse_data_por_emisor_mes_actual_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('consumidos', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['consumidos'];
    }

    /**
     * Sets consumidos
     *
     * @param int|null $consumidos consumidos
     *
     * @return self
     */
    public function setConsumidos($consumidos)
    {
        if (is_null($consumidos)) {
            throw new \InvalidArgumentException('non-nullable consumidos cannot be null');
        }
        $this->container['consumidos'] = $consumidos;
