...
class CancellationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'motivo' => 'setMotivo',
        'folio_sustitucion_uuid' => 'setFolioSustitucionUuid'
    ];
    ...
    protected static $getters = [
        'motivo' => 'getMotivo',
        'folio_sustitucion_uuid' => 'getFolioSustitucionUuid'
    ];
    ...
    public const MOTIVO__01 = '01';
    public const MOTIVO__02 = '02';
    public const MOTIVO__03 = '03';
    public const MOTIVO__04 = '04';
     ...
     * @return string[]
     */
    public function getMotivoAllowableValues()
    {
        return [
            self::MOTIVO__01,
            self::MOTIVO__02,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('folio_sustitucion_uuid', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['motivo'] === null) {
            $invalidProperties[] = "'motivo' can't be null";
        }
        $allowedValues = $this->getMotivoAllowableValues();
        if (!is_null($this->container['motivo']) && !in_array($this->container['motivo'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'motivo', must be one of '%s'",
                $this->container['motivo'],
     ...
     * Sets motivo
     *
     * @param string $motivo Motivo SAT (01-04). El 01 exige folio_sustitucion_uuid.
     *
     * @return self
     */
    public function setMotivo($motivo)
    {
        ...
        $allowedValues = $this->getMotivoAllowableValues();
        if (!in_array($motivo, $allowedValues, true)) {
    ...
    /**
     * Gets folio_sustitucion_uuid
     *
     * @return string|null
     */
    public function getFolioSustitucionUuid()
    {
        return $this->container['folio_sustitucion_uuid'];
    }

    /**
     * Sets folio_sustitucion_uuid
     *
     * @param string|null $folio_sustitucion_uuid UUID del CFDI que sustituye (obligatorio con motivo 01).
     *
     * @return self
     */
    public function setFolioSustitucionUuid($folio_sustitucion_uuid)
    {
        if (is_null($folio_sustitucion_uuid)) {
            array_push($this->openAPINullablesSetToNull, 'folio_sustitucion_uuid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('folio_sustitucion_uuid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['folio_sustitucion_uuid'] = $folio_sustitucion_uuid;
