...
class WebhookConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVENTS_CFDI_TIMBRADO = 'cfdi.timbrado';
    public const EVENTS_CFDI_CANCELADO = 'cfdi.cancelado';
    public const EVENTS_CFDI_CANCELACION_RECHAZADA = 'cfdi.cancelacion_rechazada';
    public const EVENTS_TIMBRES_BAJO_SALDO = 'timbres.bajo_saldo';
    public const EVENTS_EMISOR_CSD_POR_VENCER = 'emisor.csd_por_vencer';
    ...
    {
        return [
            self::EVENTS_CFDI_TIMBRADO,
            self::EVENTS_CFDI_CANCELADO,
            self::EVENTS_CFDI_CANCELACION_RECHAZADA,
            self::EVENTS_TIMBRES_BAJO_SALDO,
            self::EVENTS_EMISOR_CSD_POR_VENCER,
        ];
    }
    ...
    */
     ...
     * Sets url
     *
     * @param string $url Endpoint HTTPS del integrador (se bloquean IPs privadas — anti-SSRF).
     *
     * @return self
     */
     ...
     * Sets events
     *
     * @param string[] $events Eventos suscritos.
     *
     * @return self
     */
