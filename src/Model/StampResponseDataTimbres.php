...
/**
 * StampResponseDataTimbres Class Doc Comment
 *
 * @category Class
 * @package  Facter\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class StampResponseDataTimbres implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StampResponse_data_timbres';
    ...
    protected static $setters = [
        ...
        'saldo_restante' => 'setSaldoRestante'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('saldo_restante', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['saldo_restante'];
    }

    /**
     * Sets saldo_restante
     *
     * @param int|null $saldo_restante saldo_restante
     *
     * @return self
     */
    public function setSaldoRestante($saldo_restante)
    {
        if (is_null($saldo_restante)) {
            throw new \InvalidArgumentException('non-nullable saldo_restante cannot be null');
        }
        $this->container['saldo_restante'] = $saldo_restante;
