...
/**
 * Pagos20Totales Class Doc Comment
 *
 * @category Class
 * @package  Facter\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class Pagos20Totales implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pagos20_Totales';
    ...
    protected static $setters = [
        'monto_total_pagos' => 'setMontoTotalPagos'
    ];
    ...
    protected static $getters = [
        'monto_total_pagos' => 'getMontoTotalPagos'
    ];
    ...
    {
        $this->setIfExists('monto_total_pagos', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets monto_total_pagos
     *
     * @return string|null
     */
    public function getMontoTotalPagos()
    {
        return $this->container['monto_total_pagos'];
    }

    /**
     * Sets monto_total_pagos
     *
     * @param string|null $monto_total_pagos monto_total_pagos
     *
     * @return self
     */
    public function setMontoTotalPagos($monto_total_pagos)
    {
        if (is_null($monto_total_pagos)) {
            throw new \InvalidArgumentException('non-nullable monto_total_pagos cannot be null');
        }
        $this->container['monto_total_pagos'] = $monto_total_pagos;
