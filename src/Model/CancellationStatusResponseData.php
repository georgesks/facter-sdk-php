<?php
/**
 * CancellationStatusResponseData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CancellationStatusResponseData Class Doc Comment
 *
 * @category Class
 * @package  Facter\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CancellationStatusResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancellationStatusResponse_data';
    ...
    public const CANCEL_STATUS_SOLICITADO_201 = 'SOLICITADO_201';
    public const CANCEL_STATUS_EN_PROCESO_ACEPTACION = 'EN_PROCESO_ACEPTACION';
    public const CANCEL_STATUS_CANCELADO = 'CANCELADO';
    public const CANCEL_STATUS_RECHAZADO = 'RECHAZADO';
    ...
    {
        return [
            self::CANCEL_STATUS_SOLICITADO_201,
            self::CANCEL_STATUS_EN_PROCESO_ACEPTACION,
            self::CANCEL_STATUS_CANCELADO,
            self::CANCEL_STATUS_RECHAZADO,
        ];
    }
    ...
    */
     ...
     * Sets cancel_status
     *
     * @param string|null $cancel_status Estado del flujo de cancelación SAT.
     *
     * @return self
     */
