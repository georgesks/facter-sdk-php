...
/**
 * CsdUploadRequest Class Doc Comment
 *
 * @category Class
 * @package  Facter\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CsdUploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CsdUploadRequest';
    ...
    protected static $setters = [
        'cer_base64' => 'setCerBase64',
        'key_base64' => 'setKeyBase64',
    ...
    protected static $getters = [
        'cer_base64' => 'getCerBase64',
        'key_base64' => 'getKeyBase64',
    ...
    {
        $this->setIfExists('cer_base64', $data ?? [], null);
        $this->setIfExists('key_base64', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cer_base64'] === null) {
            $invalidProperties[] = "'cer_base64' can't be null";
        }
        if ($this->container['key_base64'] === null) {
            $invalidProperties[] = "'key_base64' can't be null";
        }
     ...
     * @return string
     */
    public function getCerBase64()
    {
        return $this->container['cer_base64'];
    }

    /**
     * Sets cer_base64
     *
     * @param string $cer_base64 Archivo .cer del CSD en base64.
     *
     * @return self
     */
    public function setCerBase64($cer_base64)
    {
        if (is_null($cer_base64)) {
            throw new \InvalidArgumentException('non-nullable cer_base64 cannot be null');
        }
        $this->container['cer_base64'] = $cer_base64;
    ...
    {
        return $this->container['key_base64'];
    }

    /**
     * Sets key_base64
     *
     * @param string $key_base64 Archivo .key del CSD en base64.
     *
     * @return self
     */
    public function setKeyBase64($key_base64)
    {
        if (is_null($key_base64)) {
            throw new \InvalidArgumentException('non-nullable key_base64 cannot be null');
        }
        $this->container['key_base64'] = $key_base64;
