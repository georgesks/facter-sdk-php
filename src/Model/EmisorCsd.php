 ...
 */
class EmisorCsd implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Emisor_csd';
    ...
    {
        $this->setIfExists('cargado', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['cargado'];
    }

    /**
     * Sets cargado
     *
     * @param bool|null $cargado cargado
     *
     * @return self
     */
    ...
    {
        if (is_null($cargado)) {
            throw new \InvalidArgumentException('non-nullable cargado cannot be null');
        }
        $this->container['cargado'] = $cargado;
