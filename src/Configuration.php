...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://demo.facter.com.mx/api/ext/v1';
    ...
    {
        $report  = 'PHP SDK (Facter\Sdk) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://demo.facter.com.mx/api/ext/v1",
                "description" => "Demo (pruebas, sandbox de pruebas — sin cobro real)",
            ],
            [
                "url" => "https://v2.facter.com.mx/api/ext/v1",
                "description" => "Producción (timbrado real, consume timbres)",
            ]
        ];
    }
